...
constexpr const char *ESP_WIFI_SSID = "A's router";
constexpr const char *ESP_WIFI_PASS = "kmzcnxLn59gd";
constexpr const int EXAMPLE_ESP_MAXIMUM_RETRY = 4;

/* The event group allows multiple bits for each event, but we only care about
 * two events:
 * - we are connected to the AP with an IP
 * - we failed to connect after the maximum amount of retries */
constexpr const int WIFI_CONNECTED_BIT = BIT0;
constexpr const int WIFI_FAIL_BIT = BIT1;
